...
concommand.Add("_FrenchRP_SignLetter", function(ply, cmd, args)
...
local function removeLetters(ply, args)
    ...
    if ply:EntIndex() == 0 then
        FrenchRP.log("Console force-removed all letters", Color(30, 30, 30))
    else
        FrenchRP.log(ply:Nick() .. " (" .. ply:SteamID() .. ") force-removed all letters", Color(30, 30, 30))
    end

    FrenchRP.notify(ply, 0, 4, "All letters removed")
end
FrenchRP.definePrivilegedChatCommand("removeletters", "FrenchRP_AdminCommands", removeLetters)
