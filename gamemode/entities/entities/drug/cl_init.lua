...
function ENT:Draw()
    ...
    owner = (IsValid(owner) and owner:Nick()) or FrenchRP.getPhrase("unknown")

    surface.SetFont("HUDNumber5")
    local text = FrenchRP.getPhrase("drugs")
    local text2 = FrenchRP.getPhrase("priceTag", FrenchRP.formatMoney(self:Getprice()), "")
