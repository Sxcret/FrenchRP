...
function ENT:Draw()
    ...
    cam.Start3D2D(DrawPos, DrawAngles, 0.4)
        ...
        draw.DrawNonParsedSimpleText(FrenchRP.getPhrase("laws_of_the_land"), "TargetID", 279, 5, Color(255, 0, 0, 255), TEXT_ALIGN_CENTER)
...
local function addLaw(inLaw)
    local law = FrenchRP.textWrap(inLaw, "TargetID", 522)
