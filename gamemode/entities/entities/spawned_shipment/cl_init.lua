...
net.Receive("FrenchRP_shipmentSpawn", function()
...
function ENT:drawInfo()
    ...
    local text = FrenchRP.getPhrase("contents")
    ...
    text = FrenchRP.getPhrase("amount")
...
properties.Add("splitShipment",
{
    ...
    Action      =   function(self, ent)
                        ...
                        RunConsoleCommand("frenchrp", "splitshipment", ent:EntIndex())
                    end
})
