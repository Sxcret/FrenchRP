...
FrenchRP.stub{
    name = "openPocketMenu",
    description = "Open the FrenchRP pocket menu.",
    realm = "Client",
    parameters = {
    },
    returns = {
...
function FrenchRP.openPocketMenu()
    ...
    frame:SetTitle(FrenchRP.getPhrase("drop_item"))
...
function reload()
    ...
    for k,v in pairs(pocket) do
        ...
        icon.DoClick = function(self)
            ...
            net.Start("FrenchRP_spawnPocket")
                net.WriteFloat(k)
            net.SendToServer()
            pocket[k] = nil
...
net.Receive("FrenchRP_Pocket", retrievePocket)
