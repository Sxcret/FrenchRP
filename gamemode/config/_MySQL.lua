...
RP_MySQLConfig.Database_name = "FrenchRP" -- This is the name of the Database on the MySQL server. Contact the MySQL server host to find out what this is
...
WHAT TO DO IF YOU CAN'T GET IT TO WORK!
    ...
    - the same errors are also in the logs if you can't find the errors on the server.
        the logs are at garrysmod/data/FrenchRP_logs/ on the SERVER!
