--[[-------------------------------------------------------------------------
FrenchRP config settings.
-----------------------------------------------------------------------------

This is the settings file of FrenchRP. Every FrenchRP setting is listed here.

Warning:
If this file is missing settings (because of e.g. an update), FrenchRP will assume default values for these settings.
...
-- The skin FrenchRP uses. Set to "default" to use the GMod default derma theme.
GM.Config.FrenchRPSkin = "FrenchRP"
GM.Config.currency = "$"
GM.Config.chatCommandPrefix = "/"
GM.Config.F1MenuHelpPage = "http://wiki.Frenchrp.com/index.php/Main_Page"
...
-- Make sure the category is created in the Frenchrp_customthings/categories.lua, otherwise it won't work!
