...
function PANEL:UpdatePlayerData()
    ...
    self.lblName:SetText(FrenchRP.deLocalise(self.Player:Nick()))
    self.lblTeam:SetText((self.Player.FrenchRPVars and FrenchRP.deLocalise(self.Player:getFrenchRPVar("job") or "")) or team.GetName(self.Player:Team()))
    self.lblTeam:SizeToContents()
    self.lblFrags:SetText(self.Player:Frags())
    self.lblDeaths:SetText(self.Player:Deaths())
    self.lblPing:SetText(self.Player:Ping())
    self.lblWanted:SetText(self.Player:isWanted() and FrenchRP.getPhrase("Wanted_text") or "")
end
