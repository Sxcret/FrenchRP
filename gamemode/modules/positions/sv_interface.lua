FrenchRP.storeJailPos = FrenchRP.stub{
    name = "storeJailPos",
...
FrenchRP.setJailPos = FrenchRP.stub{
    name = "setJailPos",
    description = "Remove all jail positions in this map and create a new one. To add a jailpos without removing previous ones use FrenchRP.addJailPos. This jail position will be saved in the database.",
    parameters = {
        {
            name = "pos",
...
FrenchRP.addJailPos = FrenchRP.stub{
    name = "addJailPos",
...
FrenchRP.retrieveJailPos = FrenchRP.stub{
...
FrenchRP.jailPosCount = FrenchRP.stub{
    name = "jailPosCount",
...
FrenchRP.storeTeamSpawnPos = FrenchRP.stub{
...
FrenchRP.addTeamSpawnPos = FrenchRP.stub{
...
FrenchRP.removeTeamSpawnPos = FrenchRP.stub{
...
FrenchRP.retrieveTeamSpawnPos = FrenchRP.stub{
