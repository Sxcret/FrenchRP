FrenchRP.addLanguage = FrenchRP.stub{
    name = "addLanguage",
...
FrenchRP.addPhrase = FrenchRP.stub{
    name = "addPhrase",
...
FrenchRP.getPhrase = FrenchRP.stub{
    name = "getPhrase",
...
FrenchRP.getMissingPhrases = FrenchRP.stub{
...
FrenchRP.addChatCommandsLanguage = FrenchRP.stub{
    name = "addChatCommandsLanguage",
    description = "Add a translation table for chat command descriptions. See frenchrpmod/lua/frenchrp_language/chatcommands.lua for an example.",
    parameters = {
        {
            name = "languageCode",
            description = "The language code of the language. For English this is \"en\".",
...
FrenchRP.getChatCommandDescription = FrenchRP.stub{
