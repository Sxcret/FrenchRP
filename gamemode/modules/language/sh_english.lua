...
= Warning =
Sometimes when FrenchRP is updated, new phrases are added.
If you don't translate these phrases to your language, it will use the English sentence.
To fix this, join your server, open your console and enter frenchp_getphrases yourlanguage
For English the command would be:
    frenchrp_getphrases "en"
...
local my_language = {
    ...
    see_settings = "Please see the FrenchRP settings.",
    ...
    credits_see_console = "FrenchRP credits printed to console.",
    ...
    change_name = "Change your FrenchRP name",
...
FrenchRP.addLanguage("en", my_language)
