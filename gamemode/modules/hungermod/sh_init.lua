...
FoodItems = {}
function FrenchRP.createFood(name, mdl, energy, price)
    local foodItem = istable(mdl) and mdl or {model = mdl, energy = energy, price = price}
    foodItem.name = name

    if FrenchRP.DARKRP_LOADING and FrenchRP.disabledDefaults["food"][name] then return end
...
FrenchRP.getFoodItems = fp{fn.Id, FoodItems}

function FrenchRP.removeFoodItem(i)
...
FrenchRP.registerFrenchRPVar("Energy", net.WriteFloat, net.ReadFloat)

FrenchRP.createFood("Banana", {
    model = "models/props/cs_italy/bananna.mdl",
    energy = 10,
    price = 10
})
FrenchRP.createFood("Bunch of bananas", {
    model = "models/props/cs_italy/bananna_bunch.mdl",
    energy = 20,
    price = 20
})
FrenchRP.createFood("Melon", {
    model = "models/props_junk/watermelon01.mdl",
    energy = 20,
    price = 20
})
FrenchRP.createFood("Glass bottle", {
    model = "models/props_junk/GlassBottle01a.mdl",
    energy = 20,
    price = 20
})
FrenchRP.createFood("Pop can", {
    model = "models/props_junk/PopCan01a.mdl",
    energy = 5,
    price = 5
})
FrenchRP.createFood("Plastic bottle", {
    model = "models/props_junk/garbage_plasticbottle003a.mdl",
    energy = 15,
    price = 15
})
FrenchRP.createFood("Milk", {
    model = "models/props_junk/garbage_milkcarton002a.mdl",
    energy = 20,
    price = 20
})
FrenchRP.createFood("Bottle 1", {
    model = "models/props_junk/garbage_glassbottle001a.mdl",
    energy = 10,
    price = 10
})
FrenchRP.createFood("Bottle 2", {
    model = "models/props_junk/garbage_glassbottle002a.mdl",
    energy = 10,
    price = 10
})
FrenchRP.createFood("Bottle 3", {
    model = "models/props_junk/garbage_glassbottle003a.mdl",
    energy = 10,
    price = 10
})
FrenchRP.createFood("Orange", {
