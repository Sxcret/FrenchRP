-- Skin for FrenchRP gui's
SKIN = {}

SKIN.PrintName          = "FrenchRP"
SKIN.Author             = "FPtje Falco"
SKIN.DermaVersion       = 1
SKIN.GwenTexture        = Material("frenchrp/frenchrpderma.png")
...
SKIN.tex.Panels.French                = GWEN.CreateTextureBorder(256, 64, 63, 63, 16, 16, 16, 16)
...
SKIN.Colours.Label.French                 = GWEN.TextureColor(4 + 8 * 8, 500)
...
derma.DefineSkin("FrenchRP", "The official SKIN for FrenchRP", SKIN)
