...
-- You can add/remove sounds as you wish using FrenchRP.setChatSound, just follow the format used here
...
FrenchRP.getChatSound = FrenchRP.stub{
    name = "getChatSound",
...
function FrenchRP.getChatSound(text)
    return sounds[string.lower(text or "")]
end

FrenchRP.setChatSound = FrenchRP.stub{
    name = "setChatSound",
...
function FrenchRP.setChatSound(text, sndTable)
