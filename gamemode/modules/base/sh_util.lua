...
function FrenchRP.formatMoney(n)
...
---------------------------------------------------------------------------*/
function FrenchRP.findPlayer(info)
...
Taken from FAdmin
---------------------------------------------------------------------------*/
function FrenchRP.findPlayers(info)
...
local function GetAvailableVehicles(ply)
    ...
    print(FrenchRP.getPhrase("rp_getvehicles") .. "\n")
...
/*---------------------------------------------------------------------------
Whether a player has a FrenchRP privilege
---------------------------------------------------------------------------*/
function meta:hasFrenchRPPrivilege(priv)
    if FAdmin then
...
---------------------------------------------------------------------------*/
function FrenchRP.nickSortedPlayers()
...
function FrenchRP.explodeArg(arg)
    local args = {}
