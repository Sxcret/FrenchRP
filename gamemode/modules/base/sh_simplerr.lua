...
util.AddNetworkString("FrenchRP_simplerrError")
...
local function sendErrors(plys, errs)
    ...
    FrenchRP.notify(plys, 1, 120, string.format("There %s %i Lua problem%s!\nPlease check your console for more information!", one and "is" or "are", count, one and "" or 's'))
    net.Start("FrenchRP_simplerrError")
...
hook.Add("onSimplerrError", "FrenchRP_Simplerr", annoyAdmins)
...
hook.Add("PlayerInitialSpawn", "FrenchRP_Simplerr", function(ply) timer.Simple(1, fp{annoyAdmin, ply}) end)
