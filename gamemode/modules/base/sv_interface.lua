FrenchRP.initDatabase = FrenchRP.stub{
    name = "initDatabase",
    description = "Initialize the FrenchRP database.",
    parameters = {
    },
    returns = {
    },
...
FrenchRP.storeRPName = FrenchRP.stub{
    name = "storeRPName",
...
FrenchRP.retrieveRPNames = FrenchRP.stub{
...
FrenchRP.retrievePlayerData = FrenchRP.stub{
...
FrenchRP.createPlayerData = FrenchRP.stub{
...
FrenchRP.storeMoney = FrenchRP.stub{
    name = "storeMoney",
...
FrenchRP.storeSalary = FrenchRP.stub{
    name = "storeSalary",
    description = "Internal and deprecated function. Used to store a player's salary in the database.",
    deprecated = "Use the ply:setSelfFrenchRPVar(\"salary\", value) function instead.",
    parameters = {
        {
            name = "ply",
            description = "The player.",
...
FrenchRP.retrieveSalary = FrenchRP.stub{
    name = "retrieveSalary",
...
FrenchRP.restorePlayerData = FrenchRP.stub{
    name = "restorePlayerData",
    description = "Internal function that restores a player's FrenchRP information when they join.",
    parameters = {
    },
    returns = {
    },
...
FrenchRP.storeDoorData = FrenchRP.stub{
    name = "storeDoorData",
...
FrenchRP.storeTeamDoorOwnability = FrenchRP.stub{
...
FrenchRP.storeDoorGroup = FrenchRP.stub{
    name = "storeDoorGroup",
...
FrenchRP.notifyAll = FrenchRP.stub{
    name = "notifyAll",
...
FrenchRP.printMessageAll = FrenchRP.stub{
...
FrenchRP.printConsoleMessage = FrenchRP.stub{
...
FrenchRP.talkToRange = FrenchRP.stub{
    name = "talkToRange",
...
FrenchRP.talkToPerson = FrenchRP.stub{
    name = "talkToPerson",
...
FrenchRP.isEmpty = FrenchRP.stub{
    name = "isEmpty",
...
FrenchRP.findEmptyPos = FrenchRP.stub{
    name = "findEmptyPos",
...
FrenchRP.PLAYER.applyPlayerClassVars = FrenchRP.stub{
...
FrenchRP.PLAYER.removeFrenchRPVar = FrenchRP.stub{
    name = "removeFrenchRPVar",
    description = "Remove a shared variable. Exactly the same as ply:setFrenchRPVar(nil).",
    parameters = {
        {
            name = "variable",
...
FrenchRP.PLAYER.setFrenchRPVar = FrenchRP.stub{
    name = "setFrenchRPVar",
    description = "Set a shared variable. Make sure the variable is registered with FrenchRP.registerFrenchRPVar!",
    parameters = {
        {
            name = "variable",
            description = "The name of the variable.",
...
FrenchRP.PLAYER.setSelfFrenchRPVar = FrenchRP.stub{
    name = "setSelfFrenchRPVar",
...
FrenchRP.PLAYER.sendFrenchRPVars = FrenchRP.stub{
    name = "sendFrenchRPVars",
    description = "Internal function. Sends all visibleFrenchRPVars of all players to this player.",
    parameters = {
    },
    returns = {},
    metatable = FrenchRP.PLAYER
...
FrenchRP.PLAYER.setRPName = FrenchRP.stub{
    name = "setRPName",
...
FrenchRP.PLAYER.addCustomEntity = FrenchRP.stub{
    name = "addCustomEntity",
    description = "Add a custom entity to the player's limit.",
    parameters = {
        {
            name = "tblEnt",
            description = "The entity table (from the FrenchRPEntities table).",
            type = "table",
            optional = false
        }
    },
...
FrenchRP.PLAYER.removeCustomEntity = FrenchRP.stub{
...
FrenchRP.PLAYER.customEntityLimitReached = FrenchRP.stub{
...
FrenchRP.PLAYER.getPreferredModel = FrenchRP.stub{
...
FrenchRP.hookStub{
    name = "FrenchRPDBInitialized",
    description = "Called when FrenchRP is done initializing the database.",
    parameters = {
    },
    returns = {
    }
...
FrenchRP.hookStub{
    ...
    description = "Called when a player's FrenchRP name has been changed.",
    parameters = {
        {
            name = "ply",
            description = "The player.",
...
FrenchRP.hookStub{
    ...
    parameters = {
        ...
        {
            name = "entityTable",
            description = "The table of the custom entity (from the FrenchRPEntities table).",
            type = "table"
        },
        {
            name = "ent",
...
FrenchRP.hookStub{
    ...
    description = "Whether a player can see a FrenchRP log message in the console.",
    parameters = {
        {
            name = "ply",
            description = "The player.",
