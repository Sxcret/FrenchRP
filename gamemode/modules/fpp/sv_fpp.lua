...
FPP.AddDefaultBlocked("Spawning1", "frenchrp_laws")

hook.Add("FrenchRPDBInitialized", "FPPInit", function()
	FPP.Init()

	-- Migrate database.
	-- Previous versions of the database don't store the default blocked.
	-- Store them now
	if not FrenchRP.DBVersion or FrenchRP.DBVersion < 20150725 then
