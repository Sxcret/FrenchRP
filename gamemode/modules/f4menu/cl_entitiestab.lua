    ...
    for _, cat in pairs(categories) do
        ...
        dCat:SetPerformLayout(function(contents)
            for k,v in pairs(contents.Items) do
                local can, important, _, price = canBuy(v.FrenchRPItem)
...
function PANEL:generateButtons()
    local categories = FrenchRP.getCategories().entities

    createCategories(self, categories, function(item) RunConsoleCommand("FrenchRP", item.cmd) end, canBuyEntity)
end
...
function PANEL:generateButtons()
    local categories = FrenchRP.getCategories().shipments

    createCategories(self, categories, function(item) RunConsoleCommand("FrenchRP", "buyshipment", item.name) end, canBuyShipment)
end
...
function PANEL:generateButtons()
    local categories = FrenchRP.getCategories().weapons

    createCategories(self, categories, function(item) RunConsoleCommand("FrenchRP", "buy", item.name) end, canBuyGun)
end
...
function PANEL:generateButtons()
    local categories = FrenchRP.getCategories().ammo

    createCategories(self, categories, function(item) RunConsoleCommand("FrenchRP", "buyammo", item.id) end, canBuyAmmo)
end
...
function PANEL:generateButtons()
    local categories = FrenchRP.getCategories().vehicles

    createCategories(self, categories, function(item) RunConsoleCommand("FrenchRP", "buyvehicle", item.name) end, canBuyVehicle)
end
