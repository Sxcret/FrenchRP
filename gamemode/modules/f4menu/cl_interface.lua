FrenchRP.openF4Menu = FrenchRP.stub{
    name = "openF4Menu",
...
FrenchRP.closeF4Menu = FrenchRP.stub{
    name = "closeF4Menu",
...
FrenchRP.toggleF4Menu = FrenchRP.stub{
    name = "toggleF4Menu",
...
FrenchRP.getF4MenuPanel = FrenchRP.stub{
    name = "getF4MenuPanel",
...
FrenchRP.addF4MenuTab = FrenchRP.stub{
    name = "addF4MenuTab",
    ...
    returns = {
        {
            name = "index",
            description = "The index of the tab in the menu. This is the number you use for the tab in FrenchRP.switchTabOrder.",
            type = "number"
        },
        {
            name = "sheet",
...
FrenchRP.removeF4MenuTab = FrenchRP.stub{
...
FrenchRP.switchTabOrder = FrenchRP.stub{
    name = "switchTabOrder",
