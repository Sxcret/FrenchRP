FrenchRP.defineChatCommand = FrenchRP.stub{
...
FrenchRP.definePrivilegedChatCommand = FrenchRP.stub{
...
FrenchRP.hookStub{
    name = "canChatCommand",
    description = "Called when a player tries to run any chat command or uses the FrenchRP console command. ",
    parameters = {
        {
            name = "ply",
            description = "The player who spoke.",
...
FrenchRP.hookStub{
    name = "onChatCommand",
    description = "Called after a player has run any chat command or uses the FrenchRP console command. Note: the chat command has already been run. Use canChatCommand if you want to stop chat commands from being run.",
    parameters = {
        {
            name = "ply",
            description = "The player who spoke.",
